#!/usr/bin/env python3
"""Run preregistered interleaved M6.3-R2.0 observer controls."""
...
def validate_inputs(args: argparse.Namespace) -> tuple[dict, dict, str, str]:
    ...
    require(manifest["schema"] == "m6.3-r2.0-execution-manifest-v4", "execution schema")
    ...
    require(manifest["observer_controls_seen"] is False, "v4 controls already seen at freeze")
...
def main() -> int:
    ...
    try:
        ...
        document = {
            "schema": "m6.3-r2.0-observer-controls-v4",
            "status": "passed",
