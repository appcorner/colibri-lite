...
$startInfo.EnvironmentVariables["COLIBRI_FS_CACHE_ASSUMPTION"] = "M5.1-00 replay; timing not baseline"
$startInfo.EnvironmentVariables["COLIBRI_EXPERT_TRACE_OUTPUT"] = $tracePath
$startInfo.EnvironmentVariables["COLIBRI_TRACE_INSTRUMENTATION_COMMIT"] = $InstrumentationCommit
